...
export default async function SessionsCalendarPage() {
  ...
  // Fetch confirmed RSVP counts per session for attendee data
  ...
  // Fetch events the client is attending (same pattern as coach schedule)
    ...
    <>
      ...
      <div className="min-h-screen bg-background">
        <div className="px-5 pt-14 pb-24 max-w-6xl mx-auto">
          ...
          <WeekCalendarGrid sessions={taggedSessions} linkPrefix="/sessions" events={calendarEvents} attendeeData={attendeeDataMap} />
        </div>
      </div>
    </>
  )
